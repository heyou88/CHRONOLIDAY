...
time_travels = [
  {
    name: "The Neanderthal - experience",
  ...
  {
    name: "Troubles at the Roman Limes",
    location: "Germany ",
    ...
    detailed_description: "" },
  {
    ...
    detailed_description: "Generally regarded as a high point in Chinese civilization and a golden age of cosmopolitan culture Emperor Gaozu of Tang acquired a huge territory through his military campaigns and founded the Tang- dynasty." },
  {
    name: "Vikings!",
    location: "England ",
    ...
    detailed_description: "" },
  {
    ...
    detailed_description: "" },
  {
    name: "Fight for your right to vote",
    location: "England",
    period_of_time: "1885 AD",
    img_url: "https://res.cloudinary.com/dgn2w2wvl/image/upload/v1661438778/Chronolidays/vote_qs8epl.jpg",
    short_description: "Become a suffragette in England and fight for your cause of emancipation.",
    detailed_description: "" },
  {
