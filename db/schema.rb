...
ActiveRecord::Schema[7.0].define(version: 2022_08_25_150939) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["time_travel_id"], name: "index_reviews_on_time_travel_id"
  end
  ...
  add_foreign_key "reviews", "time_travels"
end
